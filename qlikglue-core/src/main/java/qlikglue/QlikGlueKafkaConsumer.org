 ...
 */
/*
 * derived from org/apache/kafka/tools/QlikGlueKafkaConsumer.java
 */
 ...
 *     See {@link qlikglue.source.kafka.QlikGlueKafkaConsumer.PartitionsRevoked}</li>
