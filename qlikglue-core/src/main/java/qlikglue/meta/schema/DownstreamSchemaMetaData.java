 ...
 * information we need and is used to decouple the code in QlikGlue
 * from the upstream representations of meta data classes that are more 
 * platform-specific. This decoupling makes the code more indepent and 
 * thus hopefully more generally useful.
 *
 */
