...
public class DownstreamColumnData {
    ...
    /**
     *
     * @return the string value for this column surrounded by single quotes
     */
    ...
    /**
     * Check the contents of this string to see if it only contains characters that can be used
     * as part of a numeric value (0-9.+-).
     *
     * @return true if only valid characters are present, false otherwise
     */
